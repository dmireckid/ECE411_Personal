# AG Report Generated 2020-02-10 16:18
This is a report about mp1 generated for mirecki2 at 2020-02-10 16:18. The autograder used commit ``0ff1981fa607`` as a starting point. If you have any questions about this report, please contact the TAs on Piazza.
### Quick Results:
 - Compilation: NO
 - Targeted: 0/31 (0.0%)
 - Timing: NO
...
Info: Running Quartus Prime Analysis & Synthesis
    ...
    Info: Processing started: Mon Feb 10 22:16:51 2020
...
Info: Quartus Prime Analysis & Synthesis was successful. 0 errors, 15 warnings
    ...
    Info: Processing ended: Mon Feb 10 22:17:14 2020
...
Info: Running Quartus Prime Shell
    ...
    Info: Intel and sold by Intel or its authorized distributors.  Please
    Info: refer to the applicable agreement for further details.
    Info: Processing started: Mon Feb 10 22:17:14 2020
...
Info: Quartus Prime Shell was successful. 0 errors, 0 warnings
    ...
    Info: Processing ended: Mon Feb 10 22:17:15 2020
...
# Start time: 22:17:15 on Feb 10,2020
# vlog -sv -work work "+incdir+/job/student/hdl" /job/student/hdl/mux.sv 
...
# vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriaii_hssi_ver -L arriaii_pcie_hip_ver -L arriaii_ver -L rtl_work -L work -voptargs=""+acc"" mp1_tb 
# Start time: 22:17:17 on Feb 10,2020
# Loading sv_std.std
...
# End time: 22:17:17 on Feb 10,2020, Elapsed time: 0:00:00
# Errors: 2, Warnings: 2
...
+------------------+-----------+-------+----------+---------+---------------------+
; Worst-case Slack ; -6.674    ; 0.145 ; N/A      ; N/A     ; -2.846              ;
;  clk             ; -6.674    ; 0.145 ; N/A      ; N/A     ; -2.846              ;
; Design-wide TNS  ; -6565.871 ; 0.0   ; 0.0      ; 0.0     ; -1866.142           ;
;  clk             ; -6565.871 ; 0.000 ; N/A      ; N/A     ; -1866.142           ;
+------------------+-----------+-------+----------+---------+---------------------+
...
; mem_wdata[9]       ; 2.5 V        ; 0 s                 ; 0 s                 ; 2.28 V                       ; 1.96e-07 V                   ; 2.31 V              ; -0.0165 V           ; 0.178 V                              ; 0.118 V                              ; 6.24e-10 s                  ; 5.76e-10 s                  ; No                         ; Yes                        ; 2.28 V                      ; 1.96e-07 V                  ; 2.31 V             ; -0.0165 V          ; 0.178 V                             ; 0.118 V                             ; 6.24e-10 s                 ; 5.76e-10 s                 ; No                        ; Yes                       ;
...
; mem_wdata[9]       ; 2.5 V        ; 0 s                 ; 0 s                 ; 2.28 V                       ; 1.82e-05 V                   ; 2.29 V              ; -0.00988 V          ; 0.149 V                              ; 0.133 V                              ; 7.27e-10 s                  ; 6.97e-10 s                  ; Yes                        ; Yes                        ; 2.28 V                      ; 1.82e-05 V                  ; 2.29 V             ; -0.00988 V         ; 0.149 V                             ; 0.133 V                             ; 7.27e-10 s                 ; 6.97e-10 s                 ; Yes                       ; Yes                       ;
...
; mem_wdata[9]       ; 2.5 V        ; 0 s                 ; 0 s                 ; 2.62 V                       ; 1.08e-06 V                   ; 2.66 V              ; -0.0305 V           ; 0.22 V                               ; 0.165 V                              ; 5.07e-10 s                  ; 4.87e-10 s                  ; No                         ; No                         ; 2.62 V                      ; 1.08e-06 V                  ; 2.66 V             ; -0.0305 V          ; 0.22 V                              ; 0.165 V                             ; 5.07e-10 s                 ; 4.87e-10 s                 ; No                        ; No                        ;
...
; Unconstrained Input Port Paths  ; 1191  ; 1191 ;
...
Info: Running Quartus Prime Timing Analyzer
    ...
    Info: Intel and sold by Intel or its authorized distributors.  Please
    Info: refer to the applicable agreement for further details.
    Info: Processing started: Mon Feb 10 22:18:47 2020
...
Info (332146): Worst-case setup slack is -6.674
    Info (332119):     Slack       End Point TNS Clock 
    Info (332119): ========= =================== =====================
    Info (332119):    -6.674           -6565.871 clk 
...
Info (332146): Worst-case minimum pulse width slack is -2.846
    Info (332119):     Slack       End Point TNS Clock 
    Info (332119): ========= =================== =====================
    Info (332119):    -2.846           -1866.142 clk 
...
Info (332146): Worst-case setup slack is -6.301
    Info (332119):     Slack       End Point TNS Clock 
    Info (332119): ========= =================== =====================
    Info (332119):    -6.301           -6211.302 clk 
...
Info (332146): Worst-case minimum pulse width slack is -2.846
    Info (332119):     Slack       End Point TNS Clock 
    Info (332119): ========= =================== =====================
    Info (332119):    -2.846           -1863.834 clk 
...
Info (332146): Worst-case setup slack is -3.257
    Info (332119):     Slack       End Point TNS Clock 
    Info (332119): ========= =================== =====================
    Info (332119):    -3.257           -3083.182 clk 
...
Info: Quartus Prime Timing Analyzer was successful. 0 errors, 4 warnings
    ...
    Info: Processing ended: Mon Feb 10 22:18:52 2020
